...
var ConfigureIndexOptionsSchema = typebox_1.Type.Object({
    spec: typebox_1.Type.Optional(typebox_1.Type.Object({
        pod: typebox_1.Type.Object({
            replicas: typebox_1.Type.Optional(types_1.ReplicasSchema),
            podType: typebox_1.Type.Optional(types_1.PodTypeSchema),
        }),
    })),
    deletionProtection: typebox_1.Type.Optional(types_1.DeletionProtectionSchema),
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (Object.keys(options).length === 0) {
                        throw new errors_1.PineconeArgumentError('The second argument to configureIndex should not be empty object. Please specify at least one property (spec, deletionProtection) to update.');
                    }
